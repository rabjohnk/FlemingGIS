...
#arcpy.CreateDomain_management(gdb, domName01, "Tree Number","Float", "Range Domain") 
...
#arcpy.AddField_management(inFeatures, Field_Name01, "Float", field_length=field_length,)
